...
#define LED25_Pin GPIO_PIN_2
#define LED25_GPIO_Port GPIOB
#define SPI3_STCP_Pin GPIO_PIN_12
#define SPI3_STCP_GPIO_Port GPIOB
#define TL2_Car_Pin GPIO_PIN_13
#define TL2_Car_GPIO_Port GPIOB
#define TL3_Car_Pin GPIO_PIN_14
#define TL3_Car_GPIO_Port GPIOB
#define LED26_Pin GPIO_PIN_15
#define LED26_GPIO_Port GPIOB
#define SPI3_ENABLE_Pin GPIO_PIN_7
#define SPI3_ENABLE_GPIO_Port GPIOC
#define SPI3_RESET_Pin GPIO_PIN_9
#define SPI3_RESET_GPIO_Port GPIOA
